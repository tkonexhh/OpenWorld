...
Shader "HMK/Scene/Impostor"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "./../../URP/HLSLIncludes/Common/Fog.hlsl"
            #include "./../../URP/HLSLIncludes/Common/Global.hlsl"
            #include "./../../URP/HLSLIncludes/Common/HMK_Common.hlsl"
            ...
            half4 frag(VertexOutput IN, out float outDepth: SV_Depth): SV_Target
            {
                ...
                o.Albedo = lerp(o.Albedo, o.Albedo * o.Albedo, ClampRange(_Wetness, 0.2, 0.55));
                ...
                // HMKSurfaceData surfaceData = InitSurfaceData(o.Albedo,o.Alpha,);
                // HMKLightingData lightingData = InitLightingData(input);
                // #if _FOG_ON
                //     color.rgb = ApplyFog(color.rgb, worldPos);
                // #endif
                return color;
            }
