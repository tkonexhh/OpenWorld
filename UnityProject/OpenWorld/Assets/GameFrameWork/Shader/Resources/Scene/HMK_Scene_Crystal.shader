...
Shader "HMK/Scene/Crystal"
{
    ...
    half4 _BaseColor, _DissolveColor;
    half _BumpScale;
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input): SV_Target
            {
                ...
                float4 reflectionColor = SAMPLE_TEXTURECUBE(_CubeMap, sampler_CubeMap, worldReflection + float3(noise * _RefractInt, 0, 0)) * float4(_BaseColor.rgb, 1)  ;


                reflectionColor.rgb = reflectionColor.rgb * surfaceData.albedo.rgb * _EmissionColor;
