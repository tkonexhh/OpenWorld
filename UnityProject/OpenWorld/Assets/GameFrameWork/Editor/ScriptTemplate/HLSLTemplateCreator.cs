...
public class HLSLTemplateCreator : EndNameEditAction
{
    ...
    public class ScriptTemplateCreator
    {
        ...
        [MenuItem("Assets/Create/Shader/HLSL", false, 1)]
        static void CreateHLSL()
        {
            ProjectWindowUtil.StartNameEditingIfProjectWindowExists(0,
                ScriptableObject.CreateInstance<HLSLTemplateCreator>(),
                GetSelectedPath() + "/new hlsl.hlsl", null,
                "Assets/GameFrameWork/Editor/ScriptTemplate/Template-Shader-HLSL.txt");
        }
    }
}