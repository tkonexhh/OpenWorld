...
namespace UnityEngine.Rendering.Universal.Internal
{
    ...
    internal class DeferredLights
    {
        ...
        //
        internal bool UseLightLayers { get { return UniversalRenderPipeline.asset.supportsLightLayers; } }
        //
        ...
        void SetupMatrixConstants(CommandBuffer cmd, ref RenderingData renderingData)
        {
            ...
            screenToWorld[0] = Matrix4x4.Inverse(toScreen * zScaleBias * gpuProj * view);
