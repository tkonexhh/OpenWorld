...
namespace OpenWorld.RenderPipelines.Runtime.PostProcessing
{
    ...
    {
        public const string title = "体积光 (LightShaft)";
    ...
    public class LightShaftRenderer : VolumeRenderer<LightShaft>
    {
        ...
        public override void Render(CommandBuffer cmd, RTHandle source, RTHandle target, ref RenderingData renderingData)
        {
            ...
            var bloomTint = mainLight.color;
            blitMaterial.SetVector(ShaderIDs.BloomTintAndThreshold, new Vector4(bloomTint.r, bloomTint.g, bloomTint.b, settings.Threshold.value));
